...
return packer.startup(function(use)
	...
	-- essential plugins
	use("tpope/vim-surround") -- ysw(what you want to surround the word with) ds(surround character to delete) cs(from character)(to character)
	use("vim-scripts/ReplaceWithRegister") -- grw (replace word)
